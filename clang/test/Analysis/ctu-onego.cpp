...
// RUN:   -emit-pch -o %t/ctudir/ctu-onego-other.cpp.ast %S/Inputs/ctu-onego-other.cpp
// RUN: cp %S/Inputs/ctu-onego-other.cpp.externalDefMap.ast-dump.txt %t/ctudir/externalDefMap.txt
// RUN: %clang_analyze_cc1 -std=c++14 -triple x86_64-pc-linux-gnu \
// RUN:   -analyzer-checker=core,debug.ExprInspection \
// RUN:   -analyzer-config eagerly-assume=false \
