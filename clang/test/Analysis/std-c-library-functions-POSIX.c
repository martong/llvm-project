...
// CHECK: Loaded summary for: struct protoent *getprotobyname(const char *name)
// CHECK: Loaded summary for: struct servent *getservbyname(const char *name, const char *proto)
// CHECK: Loaded summary for: struct netent *getnetbyname(const char *name)
// CHECK: Loaded summary for: struct hostent *gethostbyname(const char *name)
